Feature: G마켓 SRP 트래킹 로그 정합성 검증
  ...
  Scenario: 검색 결과 페이지에서 카탈로그 모듈별 상품 클릭 시 트래킹 로그 검증
    ...
    Examples:
      ...
      | 콜라        | 2 | 반복구매       | C1413652           | C1413653            | C1413654         | C1413655       |
      | 염색약      | 1 | 반복구매       | C1413645           | C1413646            | C1413647         | C1413648       |
      | 양말        | 1 | 반복구매       | C1413606           | C1413607            | C1413608         | C1413609       |
      | 물티슈      | 1 | 장바구니 모듈       | C1413652           | C1413653            | C1413654         | C1413655       |
      | 물티슈      | 1 | 장바구니VT       | C1413645           | C1413646            | C1413647         | C1413648       |
      | 물티슈       | 2 | 장바구니VT       | C1413606           | C1413607            | C1413608         | C1413609       |
