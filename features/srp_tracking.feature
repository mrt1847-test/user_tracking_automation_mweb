Feature: G마켓 SRP 트래킹 로그 정합성 검증
  ...
  Scenario: 검색 결과 페이지에서 모듈별 상품 클릭 시 트래킹 로그 검증
    ...
    Examples:
      ...
      | 물티슈   | 0번 구좌     | C1166813         | C1166814            | C1166816         |              |
      ...
      | 물티슈   | 장바구니 모듈       | C1166835           | C1166836              | C1166838        | C1166839    |
      | 물티슈   | 카탈로그 모듈       | C1166835           | C1166836              | C1166838        | C1166839    |
      | 메가커피 1만원   | 대체검색어           | C1166861           | C1166862             | C1166864        | C1166865    |
      | @34293502   | G마켓 인기 상품           | C1166861           | C1166862             | C1166864        | C1166865    |
  ...
  Scenario: 검색 결과 페이지에서 모듈별 상품 클릭 시 트래킹 로그 검증 type2
    ...
    Examples:
      ...
      | 반팔티   | 백화점픽       | C1166857            | C1166858              | C1166860        | 
      | 물티슈   | 최하단캐러셀       | C1166857            | C1166858              | C1166860        | 
      | 물티슈   | 연관키워드       | C1166857            | C1166858              | C1166860        | 
